...
<div class="formcontainer">
  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="ad" placeholder="Akademisyen Adý" value="<%=ad%>" required>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="soyad" placeholder="Akademisyen Soyadý" value="<%=soyad%>" required>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="password" id="pword" name="sifre" placeholder="Akademisyen Þifresi" value="<%=sifre%>" required>
      </div>
    </div>
    	<div class="row">
	     <div class="col-25">
...
<%}} %>
  ...
  <div class="baslikcontainer"><label>Akademisyen Ara </label><input type="text" id="ara" onkeyup="myFunction()" placeholder="Aramak istediðiniz akademisyenin ismini yazýnýz..."/></div>
