...
<%}//mesaj Bölümü son %>
  <div class="baslikcontainer"><label>DERS ONAYLAMA ÝÞLEMLERÝ</label></div>
<%ResultSet onaybekleyendersler=dersCrud.getAdminOnayBekleyenDersler();
...
<%}while(onaybekleyendersler.next()); %>
 ...
 <div class="alert-success">
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
TEBRÝKLER ONAYLANMAMIÞ DERS BULUNMUYOR.
</div>
 <%} %>
