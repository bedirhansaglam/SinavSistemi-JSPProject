...
<div id="main">
<%
if(session.getAttribute("admin_id")==null) //eðer giriþ yapýlmamýþsa giriþ yapmak için iþlemleri baþlat
{
...
if (sonuc.next()) { //eðer bir sonuç varsa yani bu bilgilere ait email ve sifre varsa giris yap
	...
	response.sendRedirect("../loginYonetici.jsp?sonuc=0"); //yoksa geri dön
}
}
